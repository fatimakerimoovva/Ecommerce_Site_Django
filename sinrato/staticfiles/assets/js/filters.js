                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="product-caption">
                                ...
                                <li class='wishlist' data-id='${product.id}'><i class="fa fa-heart" data-id='${product.id}'></i></li>
                                    <ul class='d-flex'>
                                        <li class='basket' data-id = '${product.id}'><i class="fa fa-shopping-cart" data-id = '${product.id}'></i></li>                                    </ul>
                                </div>
                            </div>
                        </div>
                    `;
                    ...
                    shopProductElement.innerHTML += `
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div class="product-caption">
                                ...
                                <ul class='d-flex'>
                                <li class='wishlist' data-id='${product.id}'><i class="fa fa-heart" data-id='${product.id}' ></i></li> 
                                        <button style='cursor:pointer; margin-left: 10px; border-radius: 5px; background-color: #fedc19; color: #111;border: 1px solid #111'><li class='basket' data-id = '${product.id}'><i  data-id = '${product.id}'></i>Add to cart</li></button>                                    
                                        </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        document.getElementById('shop-product').innerHTML += `
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-caption">
                                        ...
                                        <button style='cursor:pointer; margin-left: 10px; border-radius: 5px; background-color: #fedc19; color: #111;border: 1px solid #111'><li class='basket' data-id = '${data['id']}'><i  data-id = '${data['id']}'></i>Add to cart</li></button>                                    
                                        </div>
                                    </div>
                                </div>
                            `;
